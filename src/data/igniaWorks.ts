...
export const WORKS: WorkRecord[] = [
  ...
  { slug: "ulmuk-vase", image: ulmukMain, model: "blue-ceramic", glbUrl: "/models/ulmuk-vase.glb", extraImages: [ulmuk2, ulmuk3, ulmuk4], es: { title: "Ulmuk Vase", artist: "Ada La Cadena", material: "Cerámica esmaltada", year: "2025", edition: "Edición única", price: "€ 1.200", description: "Ulmuk es un jarrón de cerámica de forma antropomorfa: un cuerpo cerrado con cuello largo y dos asas simétricas sobre los que emerge, con perturbadora naturalidad, un rostro humano modelado en relieve. Ojos entrecerrados, nariz pronunciada, labios entreabiertos — una expresión suspendida entre el peso y la resignación, entre la memoria y el sueño.\n\nSobre toda la superficie, una ornamentación densa en azul cobalto sobre fondo blanco despliega motivos florales y arabescos que no decoran, sino que invaden: trepan por la frente, bordean los párpados, fluyen desde la boca como si el ornamento y el ser fueran una sola materia. Toques de rosa y rojo rompen la frialdad del azul y aportan una dimensión carnal, casi visceral, al conjunto.\n\nLa pieza dialoga con la tradición de la cerámica mediterránea — la talavera, el azulejo portugués, la mayólica italiana — pero la subvierte al convertir el objeto utilitario en retrato. Ulmuk no contiene flores: contiene una presencia. Una figura que observa sin mirar, que habla sin voz, que existe en ese espacio liminal donde la arcilla deja de ser materia para convertirse en memoria.", authenticity: "#0xulmk…v4se" }, en: { title: "Ulmuk Vase", artist: "Ada La Cadena", material: "Glazed ceramic", year: "2025", edition: "Unique edition", price: "€ 1,200", description: "Ulmuk is an anthropomorphic ceramic vase: a closed body with a long neck and two symmetrical handles, from which a human face modelled in relief emerges with unsettling naturalness. Half-closed eyes, a pronounced nose, parted lips — an expression suspended between weight and resignation, between memory and dream.\n\nAcross the entire surface, a dense cobalt-blue ornamentation on a white ground unfolds floral motifs and arabesques that do not decorate but invade: climbing the forehead, edging the eyelids, flowing from the mouth as if ornament and being were one single matter. Touches of pink and red break the coldness of the blue and bring a carnal, almost visceral dimension to the whole.\n\nThe piece dialogues with the Mediterranean ceramic tradition — Talavera, Portuguese azulejo, Italian maiolica — but subverts it by turning the utilitarian object into a portrait. Ulmuk does not hold flowers: it holds a presence. A figure that observes without looking, that speaks without voice, that exists in that liminal space where clay ceases to be matter and becomes memory.", authenticity: "#0xulmk…v4se" } },
  ...
  { slug: "luz-interior", image: obra8, model: "amber-glass", es: { title: "Luz interior", artist: "Tomás Vigo", material: "Vidrio soplado", year: "2025", edition: "3 de 9", price: "€ 580", description: desc.es, authenticity: "#0xf5e1…b42" }, en: { title: "Inner light", artist: "Tomás Vigo", material: "Blown glass", year: "2025", edition: "3 of 9", price: "€ 580", description: desc.en, authenticity: "#0xf5e1…b42" } },
