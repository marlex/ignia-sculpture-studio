...
import obraCuerpoFosil from "@/assets/obra-cuerpo-fosil.jpg";
import obraCombustion from "@/assets/obra-combustion.jpg";
...
export const CATALOGUE_WORK_SLUGS = ["vinculo", "mujer-y-nino", "pliegue-iii", "nervadura", "combustion", "eco", "quietud-alabastro", "ulmuk-vase", "cuerpo-fosil", "arco"] as const;
...
export const WORKS: WorkRecord[] = [
  ...
  { slug: "pliegue-iii", image: obra2, model: "marble-fold", es: { title: "Pliegue III", artist: "Alba Costa", material: "Mármol", year: "2024", edition: "1 de 5", price: "€ 7.400", description: desc.es, authenticity: "#0x598e…07e" }, en: { title: "Fold III", artist: "Alba Costa", material: "Marble", year: "2024", edition: "1 of 5", price: "€ 7,400", description: desc.en, authenticity: "#0x598e…07e" } },
  ...
  { slug: "nervadura", image: obraNervadura, model: "corten-ribbon", es: { title: "Nervadura", artist: "Sofía Méndez", material: "Acero inoxidable forjado y pulido a espejo", year: "2025", edition: "Pieza única", price: "€ 6.400", description: "Una lámina de acero inoxidable forjada en caliente y plegada hasta el límite de rotura: la nervadura se abre como una columna vertebral que hubiera crecido fuera del cuerpo. El pulido a espejo devuelve la sala al espectador mientras los cantos quedan en bruto, sin lijar, con la memoria del golpe todavía visible. Toda la pieza sostiene una sola tensión: metal duro obligado a comportarse como tejido.", authenticity: "#0x976c…938" }, en: { title: "Ribwork", artist: "Sofía Méndez", material: "Forged stainless steel, mirror-polished", year: "2025", edition: "Unique piece", price: "€ 6,400", description: "A sheet of stainless steel hot-forged and folded to the point of rupture: the ribwork opens like a spine grown outside the body. The mirror polish returns the room to the viewer while the edges stay raw and unsanded, the memory of the hammer still visible. The whole work holds a single tension: hard metal forced to behave like tissue.", authenticity: "#0x976c…938" } },
  { slug: "ulmuk-vase", image: ulmukMain, model: "blue-ceramic", glbUrl: "/models/ulmuk-vase.glb", extraImages: [ulmuk2, ulmuk3, ulmuk4], es: { title: "Ulmuk Vase", artist: "Ada La Cadena", material: "Cerámica esmaltada", year: "2025", edition: "Edición única", price: "€ 980", description: "Ulmuk es un jarrón de cerámica de forma antropomorfa: un cuerpo cerrado con cuello largo y dos asas simétricas, sobre los que emerge con perturbadora naturalidad un rostro humano modelado en relieve. Ojos entrecerrados, nariz pronunciada, labios entreabiertos. Una expresión suspendida entre el peso y la resignación, entre la memoria y el sueño.\n\nSobre toda la superficie, una ornamentación densa en azul cobalto sobre fondo blanco despliega motivos florales y arabescos que no decoran sino que invaden. Trepan por la frente, bordean los párpados, fluyen desde la boca como si el ornamento y el ser fueran una sola materia. Toques de rosa y rojo rompen la frialdad del azul y aportan una dimensión carnal, casi visceral, al conjunto.\n\nLa pieza dialoga con la tradición de la cerámica mediterránea, la talavera, el azulejo portugués, el mayólica italiano, pero la subvierte al convertir el objeto utilitario en retrato. Ulmuk habla sin voz, existe en ese espacio liminal donde la arcilla deja de ser materia para convertirse en memoria.", authenticity: "#0xulmk…v4se" }, en: { title: "Ulmuk Vase", artist: "Ada La Cadena", material: "Glazed ceramic", year: "2025", edition: "Unique edition", price: "€ 980", description: "Ulmuk is an anthropomorphic ceramic vase: a closed body with a long neck and two symmetrical handles, from which a human face modelled in relief emerges with unsettling naturalness. Half-closed eyes, a pronounced nose, parted lips. An expression suspended between weight and resignation, between memory and dream.\n\nAcross the entire surface, a dense cobalt-blue ornamentation on a white ground unfolds floral motifs and arabesques that do not decorate but invade. They climb the forehead, edge the eyelids, flow from the mouth as if ornament and being were one single matter. Touches of pink and red break the coldness of the blue and bring a carnal, almost visceral dimension to the whole.\n\nThe piece dialogues with the Mediterranean ceramic tradition — Talavera, Portuguese azulejo, Italian maiolica — but subverts it by turning the utilitarian object into a portrait. Ulmuk speaks without voice, existing in that liminal space where clay ceases to be matter and becomes memory.", authenticity: "#0xulmk…v4se" } },
  { slug: "cuerpo-fosil", image: obraCuerpoFosil, model: "blue-ceramic", es: { title: "Cuerpo fósil", artist: "Lucía Pardo", material: "Gres chamotado, esmalte de ceniza y óxido de hierro", year: "2025", edition: "Pieza única", price: "€ 3.100", description: "Gres chamotado cocido a alta temperatura en horno de leña, con esmalte de ceniza que se agrieta al enfriar y óxido de hierro aplicado en capas hasta ennegrecer las crestas. La forma alude a una vértebra ampliada, un resto orgánico que la cerámica conserva sin idealizar. Cada fisura es irrepetible: pertenece a esta única cocción.", authenticity: "#0xa614…22f" }, en: { title: "Fossil Body", artist: "Lucía Pardo", material: "Chamotte stoneware, ash glaze and iron oxide", year: "2025", edition: "Unique piece", price: "€ 3,100", description: "Chamotte stoneware wood-fired at high temperature, with an ash glaze that cracks as it cools and iron oxide layered until the crests blacken. The form suggests an enlarged vertebra, an organic remain the clay preserves without idealising it. Every fissure is unrepeatable: it belongs to this single firing.", authenticity: "#0xa614…22f" } },
  ...
  { slug: "combustion", image: obraCombustion, model: "amber-glass", es: { title: "Combustión", artist: "Tomás Vigo", material: "Vidrio soplado en caliente sobre estructura de hierro oxidado", year: "2025", edition: "Pieza única", price: "€ 4.700", description: "Vidrio soplado directamente sobre una estructura de hierro corroído: la masa incandescente se derrama entre las barras y queda atrapada al enfriar, sin corrección posterior. El resultado es un cuerpo ámbar oscuro que parece detenido a mitad de una combustión, sostenido por el mismo metal que lo hiere. Un riesgo material irreversible, resuelto en una sola operación de taller.", authenticity: "#0xf5e1…b42" }, en: { title: "Combustion", artist: "Tomás Vigo", material: "Hot-blown glass on an oxidised iron armature", year: "2025", edition: "Unique piece", price: "€ 4,700", description: "Glass blown directly onto a corroded iron armature: the incandescent mass spills between the bars and is trapped as it cools, with no later correction. The result is a dark amber body that seems halted mid-combustion, held by the very metal that wounds it. An irreversible material risk resolved in a single studio operation.", authenticity: "#0xf5e1…b42" } },
