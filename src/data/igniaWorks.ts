...
export const HERO_WORK_SLUGS = ["lirio-en-vuelo", "ofrenda", "torsion-i"] as const;
export const CATALOGUE_WORK_SLUGS = ["confluencia", "pliegue-iii", "vertigo", "raiz", "origen", "eco", "quietud-alabastro", "luz-interior"] as const;
