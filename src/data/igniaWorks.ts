...
export const WORKS: WorkRecord[] = [
  { slug: "hecate-triformis", image: hero1, model: "hero-flight", glbUrl: GLB_HECATE, extraImages: [obra2, obra3], es: { title: "Hécate Triformis", artist: "Anónimo (c. 50–350 d.C.)", material: "Mármol", year: "c. 50–350 d.C.", edition: "Pieza única", price: "€ 24.000", description: "Reproducción escultórica de la Hécate Triformis. Disponible con vista 3D interactiva para apreciarla desde cualquier ángulo.", authenticity: "#0x3a9f…c21" }, en: { title: "Hecate Triformis", artist: "Anonymous (c. 50–350 CE)", material: "Marble", year: "c. 50–350 CE", edition: "Unique piece", price: "€ 24,000", description: "Sculptural reproduction of Hecate Triformis. Available with interactive 3D view from every angle.", authenticity: "#0x3a9f…c21" } },
  { slug: "mujer-y-nino", image: obra1, model: "figure-curvy", glbUrl: GLB_MUJER, extraImages: [obra2, obra3], es: { title: "Mujer y Niño", artist: "Helena Vázquez", material: "Bronce patinado", year: "2024", edition: "Edición única", price: "€ 11.800", description: "Estudio escultórico de figura materna. Pieza con visor 3D activo para explorarla desde cualquier ángulo.", authenticity: "#0x787d…4db" }, en: { title: "Woman and Child", artist: "Helena Vázquez", material: "Patinated bronze", year: "2024", edition: "Unique edition", price: "€ 11,800", description: "Sculptural study of a maternal figure. Piece with active 3D viewer to explore from every angle.", authenticity: "#0x787d…4db" } },
