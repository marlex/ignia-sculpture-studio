...
export const WORKS: WorkRecord[] = [
  { slug: "hecate-triformis", image: hecate1, model: "hero-flight", glbUrl: GLB_HECATE, extraImages: [hecate2, hecate3], es: { title: "Hécate Triformis", artist: "Anónimo (c. 50–350 d.C.)", material: "Mármol", year: "c. 50–350 d.C.", edition: "Pieza única", price: "€ 2.600", description: "Reproducción escultórica de la Hécate Triformis. Disponible con vista 3D interactiva para apreciarla desde cualquier ángulo.", authenticity: "#0x3a9f…c21" }, en: { title: "Hecate Triformis", artist: "Anonymous (c. 50–350 CE)", material: "Marble", year: "c. 50–350 CE", edition: "Unique piece", price: "€ 2,600", description: "Sculptural reproduction of Hecate Triformis. Available with interactive 3D view from every angle.", authenticity: "#0x3a9f…c21" } },
