...
export const WORKS: WorkRecord[] = [
  ...
  { slug: "nervadura", image: obraNervadura, model: "corten-ribbon", es: { title: "Nervadura", artist: "Sofía Méndez", material: "Acero inoxidable forjado y pulido a espejo", year: "2025", edition: "Pieza única", price: "€ 10.200", description: "Una lámina de acero inoxidable forjada en caliente y plegada hasta el límite de rotura: la nervadura se abre como una columna vertebral que hubiera crecido fuera del cuerpo. El pulido a espejo devuelve la sala al espectador mientras los cantos quedan en bruto, sin lijar, con la memoria del golpe todavía visible. Toda la pieza sostiene una sola tensión: metal duro obligado a comportarse como tejido.", authenticity: "#0x976c…938" }, en: { title: "Ribwork", artist: "Sofía Méndez", material: "Forged stainless steel, mirror-polished", year: "2025", edition: "Unique piece", price: "€ 10,200", description: "A sheet of stainless steel hot-forged and folded to the point of rupture: the ribwork opens like a spine grown outside the body. The mirror polish returns the room to the viewer while the edges stay raw and unsanded, the memory of the hammer still visible. The whole work holds a single tension: hard metal forced to behave like tissue.", authenticity: "#0x976c…938" } },
  ...
  { slug: "cuerpo-fosil", image: obraCuerpoFosil, model: "blue-ceramic", es: { title: "Cuerpo fósil", artist: "Lucía Pardo", material: "Gres chamotado, esmalte de ceniza y óxido de hierro", year: "2025", edition: "Pieza única", price: "€ 4.100", description: "Gres chamotado cocido a alta temperatura en horno de leña, con esmalte de ceniza que se agrieta al enfriar y óxido de hierro aplicado en capas hasta ennegrecer las crestas. La forma alude a una vértebra ampliada, un resto orgánico que la cerámica conserva sin idealizar. Cada fisura es irrepetible: pertenece a esta única cocción.", authenticity: "#0xa614…22f" }, en: { title: "Fossil Body", artist: "Lucía Pardo", material: "Chamotte stoneware, ash glaze and iron oxide", year: "2025", edition: "Unique piece", price: "€ 4,100", description: "Chamotte stoneware wood-fired at high temperature, with an ash glaze that cracks as it cools and iron oxide layered until the crests blacken. The form suggests an enlarged vertebra, an organic remain the clay preserves without idealising it. Every fissure is unrepeatable: it belongs to this single firing.", authenticity: "#0xa614…22f" } },
  { slug: "eco", image: obra6, model: "slender-figure", es: { title: "Eco", artist: "Pablo Reyes", material: "Bronce", year: "2024", edition: "Edición única", price: "€ 8.200", description: desc.es, authenticity: "#0xbf03…686" }, en: { title: "Echo", artist: "Pablo Reyes", material: "Bronze", year: "2024", edition: "Unique edition", price: "€ 8,200", description: desc.en, authenticity: "#0xbf03…686" } },
  ...
  { slug: "combustion", image: obraCombustion, model: "amber-glass", es: { title: "Combustión", artist: "Tomás Vigo", material: "Vidrio soplado en caliente sobre estructura de hierro oxidado", year: "2025", edition: "Pieza única", price: "€ 6.800", description: "Vidrio soplado directamente sobre una estructura de hierro corroído: la masa incandescente se derrama entre las barras y queda atrapada al enfriar, sin corrección posterior. El resultado es un cuerpo ámbar oscuro que parece detenido a mitad de una combustión, sostenido por el mismo metal que lo hiere. Un riesgo material irreversible, resuelto en una sola operación de taller.", authenticity: "#0xf5e1…b42" }, en: { title: "Combustion", artist: "Tomás Vigo", material: "Hot-blown glass on an oxidised iron armature", year: "2025", edition: "Unique piece", price: "€ 6,800", description: "Glass blown directly onto a corroded iron armature: the incandescent mass spills between the bars and is trapped as it cools, with no later correction. The result is a dark amber body that seems halted mid-combustion, held by the very metal that wounds it. An irreversible material risk resolved in a single studio operation.", authenticity: "#0xf5e1…b42" } },
