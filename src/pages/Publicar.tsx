  ...
  return (
    <main style={{ background: "#FFFFFF", minHeight: "100vh" }}>
      ...
      <section style={{ maxWidth: 720, margin: "0 auto", padding: "80px 24px 120px" }}>
        <h1 style={{ fontFamily: "Urbanist, sans-serif", fontWeight: 700, color: "#111111", fontSize: 40, lineHeight: 1.1, letterSpacing: "-0.02em", marginBottom: 16 }}>
          Publicar una obra
        </h1>
        ...
        {submitted ? (
          <div>
            <h2 style={{ fontFamily: "Urbanist, sans-serif", fontWeight: 700, color: "#111111", fontSize: 28, marginBottom: 16 }}>
              Obra recibida.
            </h2>
        ...
        <form onSubmit={onSubmit}>
          ...
          <button
            type="submit"
            disabled={loading}
            style={{ width: "100%", background: "#111111", color: "#FFFFFF", fontFamily: "Urbanist, sans-serif", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.14em", fontSize: 13, padding: 18, border: "none", borderRadius: 0, cursor: "pointer", marginTop: 24, transition: "background-color 250ms" }}
