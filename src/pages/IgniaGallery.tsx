...
const T = {
  es: {
    ...
    offers: [
      ...
      { t: "Comisiones justas", d: "Valoramos el esfuerzo y la calidad detrás de cada obra." },
    ...
    <main className="pt-14">
      ...
      <section className="relative h-[70vh] min-h-[460px] overflow-hidden">
        ...
        <div className="relative h-full flex flex-col justify-center items-center text-center px-6 md:px-12 max-w-[1280px] mx-auto">
          ...
          <h1 className="font-display font-medium text-white text-[clamp(40px,6vw,76px)] tracking-[-0.02em] leading-[1.02] max-w-[900px]">{t.h}</h1>
      ...
      <section className="relative bg-white px-6 md:px-12 py-28 md:py-36 text-center overflow-hidden">
        <span
          ...
          aria-hidden
        >
          <Logo fill="#f2f2f2" style={{ width: "clamp(300px, 70vw, 900px)", height: "auto" }} />
        </span>
