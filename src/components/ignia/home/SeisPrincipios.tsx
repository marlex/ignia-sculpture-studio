  ...
  return (
    <section className="seis-principios w-full bg-white">
      <style>{`
        ...
        .sp-num { font-family:${DM}; font-size:13px; letter-spacing:0.15em; color:#b8b0a0; margin:0 0 28px; font-weight:400; }
        .sp-rt { font-family:${DM}; font-size:22px; font-weight:400; line-height:1.3; color:#111; margin:0 0 20px; }
        .sp-desc { font-family:${CG}; font-size:18px; font-weight:500; line-height:1.75; color:#777; margin:0; max-width:460px; }
