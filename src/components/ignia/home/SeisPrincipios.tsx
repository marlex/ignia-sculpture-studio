  ...
  return (
    <section className="seis-principios w-full bg-[#fafaf7]">
      <style>{`
        ...
        .sp-title { font-family:${CG}; font-weight:600; font-size:clamp(40px,5vw,64px); color:#111; line-height:1.05; letter-spacing:-0.02em; margin:0 0 120px; white-space: pre-line; }
        .sp-title em { font-style:italic; font-weight:600; color:#8a8270; }
        ...
        .sp-body { min-width:0; }
        .sp-rt { font-family:${CG}; font-size:30px; font-weight:600; line-height:1.25; color:#111; margin:0 0 18px; letter-spacing:-0.01em; max-width:24ch; }
        .sp-desc { font-family:${MAN}; font-size:16px; font-weight:400; line-height:1.7; color:#121212; margin:0; max-width:42ch; }
