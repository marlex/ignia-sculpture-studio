      ...
      <div ref={ref} className="max-w-[1280px] mx-auto" style={{ textAlign: "center" }}>
        ...
        <div style={{ marginTop: 48, display: "flex", gap: 32, justifyContent: "center", alignItems: "center", flexWrap: "wrap" }}>
          <button
            onClick={onInvite}
            className="font-body"
            style={{ fontWeight: 300, fontSize: 14, letterSpacing: "0.14em", textTransform: "uppercase", padding: "18px 36px", background: "#111111", color: "#FFFFFF", border: "1px solid #FFFFFF", borderRadius: 0, cursor: "pointer", transition: "background-color 250ms" }}
          >
          ...
          <button
            ...
            className="font-body"
            style={{ fontWeight: 300, fontSize: 14, letterSpacing: "0.14em", textTransform: "uppercase", color: "#FFFFFF", background: "transparent", border: "none", cursor: "pointer" }}
          >
            Ver la colección
          </button>
        </div>
