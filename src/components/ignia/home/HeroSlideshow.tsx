    ...
    <section className="relative w-full h-screen overflow-hidden" style={{ background: "#111111" }}>
      ...
      <div className="relative z-10 h-full flex items-center px-6 md:px-16 lg:px-24">
        <div className="max-w-[720px]">
          <h1
            style={{ fontFamily: "Urbanist, sans-serif", fontWeight: 700, color: "#FFFFFF", fontSize: "clamp(40px, 6.2vw, 72px)", lineHeight: 1.05, letterSpacing: "-0.02em" }}
          >
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            <button
              ...
              style={{ fontFamily: "Urbanist, sans-serif", fontWeight: 700, fontSize: "13px", letterSpacing: "0.14em", textTransform: "uppercase", padding: "16px 32px", background: "#FFFFFF", color: "#111111", border: "none", borderRadius: 0, cursor: "pointer", transition: "background-color 250ms" }}
            >
            ...
            <button
              ...
              style={{ fontFamily: "Urbanist, sans-serif", fontWeight: 700, fontSize: "13px", letterSpacing: "0.14em", textTransform: "uppercase", padding: "16px 32px", background: "transparent", color: "#FFFFFF", border: "1px solid #FFFFFF", borderRadius: 0, cursor: "pointer", transition: "background-color 250ms" }}
            >
              Ver la colección
            </button>
          </div>
