            ...
            <div key={c.label}>
              ...
              {SHOW_PUBLIC_AUTH && (
                <div className="flex flex-col gap-2.5 mt-4">
                  {c.links.map(l => (
<Link key={l.label} to={l.to} className="font-body text-[16px] font-light text-gray hover:opacity-65 transition-opacity">{l.label}</Link>
                  ))}
                </div>
              )}
            </div>
      ...
      <div className="-mx-6 md:-mx-12 px-6 md:px-12 py-6 bg-secondary flex justify-between flex-wrap gap-x-8 gap-y-3 items-center">
        <div className="flex flex-wrap items-center gap-x-8 gap-y-2">
          <Link to="/legal/terminos" className="font-body text-[13px] font-light text-ink hover:opacity-65 transition-opacity tracking-[0.14em] uppercase">
            {lang === "es" ? "Términos y Condiciones" : "Terms & Conditions"}
          </Link>
          <Link to="/legal/privacidad" className="font-body text-[13px] font-light text-ink hover:opacity-65 transition-opacity tracking-[0.14em] uppercase">
            {lang === "es" ? "Política de Privacidad" : "Privacy Policy"}
          </Link>
          <Link to="/legal/envios-y-devoluciones" className="font-body text-[13px] font-light text-ink hover:opacity-65 transition-opacity tracking-[0.14em] uppercase">
