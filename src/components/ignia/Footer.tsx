...
<Link key={l.label} to={l.to} className="font-body text-[16px] font-normal text-gray hover:opacity-65 transition-opacity">{l.label}</Link>
      ...
      <div className="mt-10 pt-10 pb-0 border-t border-border">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:max-w-[520px] gap-x-6 gap-y-4 items-center">
          <a href="https://www.instagram.com/igniaartcollective/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="flex items-center gap-3 text-ink hover:opacity-65 transition-opacity duration-200">
          ...
          <a href="https://www.linkedin.com/company/igniainstitution" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="flex items-center gap-3 text-ink hover:opacity-65 transition-opacity duration-200">
          ...
          <a href="https://www.facebook.com/people/IGNIA-The-Digital-Institution-for-Sculpture/61591349492969/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="flex items-center gap-3 text-ink hover:opacity-65 transition-opacity duration-200">
          ...
          <a href="https://www.tiktok.com/@igniainstitution" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="flex items-center gap-3 text-ink hover:opacity-65 transition-opacity duration-200">
          ...
          <a href="https://x.com/igniainstitutio" target="_blank" rel="noopener noreferrer" aria-label="X" className="flex items-center gap-3 text-ink hover:opacity-65 transition-opacity duration-200">
          ...
          <a href="https://www.youtube.com/@IgniaInstitution" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="flex items-center gap-3 text-ink hover:opacity-65 transition-opacity duration-200">
