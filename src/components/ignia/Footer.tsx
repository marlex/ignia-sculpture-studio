...
<Link key={l.label} to={l.to} className="font-body text-[16px] font-normal text-gray hover:opacity-65 transition-opacity">{l.label}</Link>
      ...
      <div className="mt-20 pt-10 pb-12 border-t border-border">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-x-6 gap-y-4 items-center">
      ...
      <div className="max-w-5xl lg:mx-auto -mx-6 md:-mx-12 px-6 md:px-12 py-6 bg-secondary flex justify-between flex-wrap gap-x-8 gap-y-3 items-center">
