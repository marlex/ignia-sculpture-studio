    ...
    <footer className="footer-section bg-white border-t-[0.5px] border-border px-6 md:px-12 pt-14 pb-8">
      ...
      <div className="border-t-[0.5px] border-border mt-10 pt-5">
        ...
        <div className="flex items-center gap-4">
          <a href="https://www.instagram.com/igniagallery/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-ink hover:opacity-60 transition-opacity duration-200">
          ...
          <a href="https://www.linkedin.com/company/igniagallery/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-ink hover:opacity-60 transition-opacity duration-200">
          ...
          <a href="https://www.facebook.com/people/Ignia-Gallery/61591349492969/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-ink hover:opacity-60 transition-opacity duration-200">
