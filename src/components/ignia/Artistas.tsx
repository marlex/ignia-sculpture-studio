...
const data = {
  Establecidos: [
    ...
    { foto: "https://images.unsplash.com/photo-1607746882042-944635dfe10e?w=600&q=80", nombre: "Marcos Iriarte", esp: "Abstracción metálica", obras: "18 obras" },
    { foto: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=600&q=80", nombre: "Ana Ruiz", esp: "Mármol y piedra", obras: "31 obras" },
  ],
  Emergentes: [
    ...
    { foto: "https://images.unsplash.com/photo-1557862921-37829c790f19?w=600&q=80", nombre: "Diego Lara", esp: "Acero contemporáneo", obras: "12 obras" },
    { foto: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=600&q=80", nombre: "Sofía Méndez", esp: "Madera tallada", obras: "7 obras" },
  ],
};
